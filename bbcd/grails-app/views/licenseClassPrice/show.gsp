...
<html>
    <head>
        ...
        <title>Show LicenseClassPrice</title>
    </head>
    <body>
        <div class="nav">
                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${fieldValue(bean:licenseClassPrice, field:'id')}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${fieldValue(bean:licenseClassPrice, field:'price')}</td>
