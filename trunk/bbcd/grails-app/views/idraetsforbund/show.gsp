...
<html>
    <head>
        ...
        <title>Show Idraetsforbund</title>
    </head>
    <body>
        <div class="nav">
                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${idraetsforbund.id}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${idraetsforbund.name}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${idraetsforbund.xmlId}</td>
